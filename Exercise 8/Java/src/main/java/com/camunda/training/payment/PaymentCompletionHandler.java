...
public class PaymentCompletionHandler implements ExternalTaskHandler {
	...
	public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
	    ...
	    try {
	    	...
	    	List<MessageCorrelationResultWithVariableDto> correlationResult = new MessageApi(client).deliverMessage(new CorrelationMessageDto().messageName("paymentCompletedMessage").correlationKeys(correlationKey).resultEnabled(true));
